(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.kennedi, 400, 560,5,0.2 );
        collectable.create(type.grace, 100,475,4,0.7);
        collectable.create(type.max,145,825,3,0.6);
        // example: 
        collectable.create(type.steve, 200, 170, 6, 0.4);
